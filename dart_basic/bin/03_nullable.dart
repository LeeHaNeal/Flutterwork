/*
  - NUll safety타입 : 2.12 버전부터 도입
    null 값에 대한 안정성을 보장하기 ㅜ이해 모든 변수는 nullable과 non-nullable로 구분
...
void main () {
  ...
  // !(느낌표) : nullable type으로 선언을 했을 때 변수 뒤에 !를 붙여 null인경우 오류를 발생하도록
...
//  print(name4!);  // 오류 TypeError
  ...
  int? num1;
  int num2 = 3;
  // print(num1 + num2); 오류 null값 허용타입과 허용되지 않는 타입
  // print(num1! + num2);  // build에서는 오류가 안뜨지만 실행시 오류

  // ?? : null일 때 대체 값을 넣어줄 수 있음
